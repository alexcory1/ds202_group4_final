...
For this graph, they stopped reporting total released and total hospitalized data after December 5th, 2021.
```{r}
...
This graph shows the correlation between new cases and new deaths. Only 43.55611% of the variability in new deaths can be explained by new cases.

```{r}
df1 %>% drop_na()
cor(df1$deathsDelta, df1$CaseDelta)
